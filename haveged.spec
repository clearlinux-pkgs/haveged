...
Source0  : https://github.com/jirka-h/haveged/archive/v1.9.9/haveged-1.9.9.tar.gz
...
%prep
%setup -q -n haveged-1.9.9
cd %{_builddir}/haveged-1.9.9
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1591755715
...
cp %{_builddir}/haveged-1.9.9/COPYING %{buildroot}/usr/share/package-licenses/haveged/8624bcdae55baeef00cd11d5dfcfa60f68710a02
%make_install
